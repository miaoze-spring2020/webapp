...
public class DAO {
    ...
    private static final SessionFactory sessionfactory = new Configuration().configure("hibernate.cfg.xml")
            .setProperty("hibernate.connection.url", "jdbc:mysql://" + System.getenv("DB_HOSTNAME") + ":3306/csye6225?createDatabaseIfNotExist=true&useSSL=true&verifyServerCertificate=false&requireSSL=true")
